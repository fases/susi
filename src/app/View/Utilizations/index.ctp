<div class="utilizations index">
	...
	<tr>
		...
		<td><?php echo h($utilization['Utilization']['name']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $utilization['Utilization']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $utilization['Utilization']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
