...
<?php echo $this->Form->create('CampusItem'); ?>
	<fieldset>
		<legend><?php echo __('Edit Campus Item'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('CampusItem.id')), array('confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('CampusItem.id')))); ?></li>
